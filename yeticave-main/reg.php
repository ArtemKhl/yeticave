...
$categories =  ategories($connection);
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    foreach ($_POST as $index=>$value)
    {
        ...
        if($value==="")
        {
            $errors[$index]="Введите Повторно $i";
            $e=1;
        }
        else
        {
    ...
    {
        $errors['email']="Email не соответствует форме";
        $e=1;
    }
    ...
    {
        $errors['email']="Пользователь с таким Email уже сушествует";
        $e=1;
    }
    ...
    else
    {
        ...
        if ($mime != 'image/jpeg' && $mime != 'image/png') {
            $errors['image'] = 'Выберите файлы форматов.png,.jpg,.jpeg';
            $e = 1;
        }
        else {
            if(!$e)
